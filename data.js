/**
 * 产业链数据库
 * 包含：半导体、AI算力、算力租赁、预制算力中心底座、新能源汽车、光伏、电力、人工智能、锂电池、消费电子、电子纸、机器人、液冷、通讯设备、IT服务、元件、MLCC、半导体稀缺材料、多氟多、AI应用、无人驾驶、特斯拉FSD入华、存储芯片、长鑫存储、先进封装、光互联、光纤概念、CPO、物理AI、2022世界杯、2026世界杯 等（产业链见 INDUSTRY_DATA；板块龙头见 sector-data.js 的 SECTOR_DATA）
 */
const INDUSTRY_DATA = {
  // ========== 半导体 ==========
  "半导体": {
    ...
    description: "半导体产业涵盖晶圆代工、设备、封测、材料、CPU/GPU/模拟/功率芯片、EDA工具与传感器等全产业链。口径：主业与对应细分强相关；剔除科创板(688/689)。",
    upstream: [
      {
        name: "半导体材料",
        companies: [
          { name: "彤程新材", highlight: "光刻胶树脂+KrF/ArF光刻胶，晶圆厂光刻工艺材料国产替代" },
          { name: "南大光电", highlight: "ArF/KrF光刻胶+电子特气，先进制程光刻与刻蚀材料" },
          { name: "江丰电子", highlight: "高纯溅射靶材，铝/钛/钽靶材晶圆厂批量供货" },
          { name: "立昂微", highlight: "6-8英寸半导体硅片+功率外延，硅材料国产化扩产" },
          { name: "雅克科技", highlight: "电子特气+前驱体，CVD/ALD工艺高纯材料" },
          { name: "晶瑞电材", highlight: "湿电子化学品+光刻胶，晶圆制造湿法工艺材料" },
          { name: "飞凯材料", highlight: "封装光刻胶+湿制程材料，凸块与RDL先进封装化学品" },
          { name: "上海新阳", highlight: "电镀液+清洗液+光刻胶，晶圆制造湿法工艺材料平台" },
          { name: "鼎龙股份", highlight: "CMP垫+光刻胶树脂，半导体抛光与光刻材料国产替代" },
          { name: "有研新材", highlight: "高纯金属+靶材+化合物材料，半导体材料研发与量产" }
        ]
      },
      {
        name: "半导体设备",
        companies: [
          { name: "北方华创", highlight: "刻蚀+CVD+PVD平台型半导体设备，多条产线满产交付国内主流晶圆厂" },
          { name: "精测电子", highlight: "面板/半导体检测设备，膜厚/OCD/缺陷检测产线扩产" },
          { name: "长川科技", highlight: "封测分选机+SoC测试机，存储与算力芯片测试设备放量" },
          { name: "至纯科技", highlight: "湿法清洗+高纯工艺系统，晶圆厂湿法产线核心设备" },
          { name: "万业企业", highlight: "离子注入机+半导体装备，国产离子注入设备量产导入" },
          { name: "晶盛机电", highlight: "单晶炉+碳化硅长晶设备，硅片与化合物半导体材料装备" },
          { name: "新莱应材", highlight: "超高洁净管路+阀门半导体设备，晶圆厂高纯气体/化学品输送系统" },
          { name: "蓝英装备", highlight: "晶圆清洗+湿法设备，先进制程湿法工艺装备" },
          { name: "劲拓股份", highlight: "半导体封装回流焊/贴合设备，先进封装产线扩产受益" },
          { name: "张江高科", highlight: "半导体产业园+设备投资，晶圆厂产线设备配套与孵化" }
        ]
      },
      {
        name: "EDA工具/产线软件",
        companies: [
          { name: "华大九天", highlight: "国产EDA全流程，模拟/数字/平板显示EDA工具国内市占领先" },
          { name: "广立微", highlight: "良率分析与测试芯片EDA，晶圆厂良率提升工具平台" },
          { name: "太极股份", highlight: "信创+行业数字化，半导体产线信息化与EDA生态配套" },
          { name: "电科网安", highlight: "密码安全+芯片设计安全EDA工具，半导体IP安全与加密软件" },
          { name: "中国软件", highlight: "信创基础软件，半导体产线操作系统与中间件配套" },
          { name: "东华软件", highlight: "中间件+运维软件，晶圆厂IT基础设施与产线监控" },
          { name: "赛意信息", highlight: "工业互联网+智能制造，半导体工厂MES/数字化产线" },
          { name: "用友网络", highlight: "企业软件+产线ERP，半导体制造企业资源管理系统" },
          { name: "东软集团", highlight: "汽车电子+工业软件，车规芯片设计验证工具配套" },
          { name: "榕基软件", highlight: "电子政务+信创软件，半导体产线信息化配套" }
        ]
      }
    ],
    midstream: [
      {
        name: "晶圆代工/IDM",
        companies: [
          { name: "士兰微", highlight: "IDM特色工艺晶圆制造，功率+MCU+MEMS多产线满产" },
          { name: "扬杰科技", highlight: "功率器件IDM，自有晶圆产线+外延，车规与工控芯片晶圆产能扩张" },
          { name: "赛微电子", highlight: "MEMS特色工艺晶圆代工，射频/惯性传感器晶圆产线规模国内领先" },
          { name: "富满微", highlight: "模拟芯片IDM，电源管理芯片晶圆产线与封测一体化" },
          { name: "捷捷微电", highlight: "功率半导体IDM，晶闸管/保护器件晶圆产线满产" },
          { name: "台基股份", highlight: "大功率半导体器件IDM，晶圆制造+模块封装垂直整合" },
          { name: "蓝箭电子", highlight: "分立器件+集成电路封测，特色工艺晶圆产线配套" },
          { name: "国民技术", highlight: "安全芯片+MCU IDM，嵌入式安全芯片晶圆产线" },
          { name: "苏州固锝", highlight: "分立器件+传感器IDM，功率器件晶圆与封测协同" },
          { name: "华微电子", highlight: "功率半导体IDM，MOSFET/IGBT晶圆产线持续扩产" }
        ]
      },
      {
        name: "CPU/GPU芯片",
        companies: [
          { name: "兆易创新", highlight: "Nor Flash+MCU+定制存储，通用MCU与车规芯片出货量国内领先" },
          { name: "紫光国微", highlight: "FPGA+安全芯片+特种CPU，信创与特种计算芯片量产" },
          { name: "北京君正", highlight: "嵌入式CPU+存储控制器，低功耗MCU与边缘计算芯片" },
          { name: "瑞芯微", highlight: "SoC+应用处理器，智能硬件与工业控制CPU芯片" },
          { name: "全志科技", highlight: "AIoT SoC+应用处理器，平板/智能硬件主控芯片" },
          { name: "景嘉微", highlight: "国产GPU芯片，JM系列图形/通用计算芯片信创与AI场景拓展" },
          { name: "国科微", highlight: "视频编解码+AI芯片，安防与智能终端算力芯片量产" },
          { name: "富瀚微", highlight: "视频处理SoC+IPC主控，安防与智能终端CPU芯片" },
          { name: "博通集成", highlight: "WiFi/BT SoC+MCU，物联网无线连接主控芯片" },
          { name: "国民技术", highlight: "安全MCU+USB-Key芯片，嵌入式安全计算芯片" }
        ]
      },
      {
        name: "模拟/功率芯片",
        companies: [
          { name: "圣邦股份", highlight: "模拟IC设计，电源管理/信号链芯片出货量国内领先" },
          { name: "上海贝岭", highlight: "电源管理+计量芯片，工控与消费电子模拟芯片" },
          { name: "斯达半导", highlight: "IGBT模块，新能源车主驱逆变器功率模块出货量领先" },
          { name: "新洁能", highlight: "MOSFET/IGBT设计，功率器件出货量快速增长" },
          { name: "闻泰科技", highlight: "功率半导体+ODM，安世半导体功率器件整合出货" },
          { name: "露笑科技", highlight: "碳化硅衬底+功率器件，SiC产业链布局与功率芯片" },
          { name: "大唐电信", highlight: "安全芯片+通信SoC，政务与行业安全计算芯片" },
          { name: "欧比特", highlight: "宇航电子+嵌入式SoC，特种领域计算芯片" },
          { name: "旋极信息", highlight: "嵌入式安全芯片+行业算力终端" },
          { name: "智度股份", highlight: "端侧算力与智算资源整合，算力模组出货" }
        ]
      }
    ],
    downstream: [
      {
        name: "封装测试",
        companies: [
          { name: "长电科技", highlight: "全球OSAT规模前三，传统封测+先进封装双线，Chiplet/2.5D产能领先" },
          { name: "通富微电", highlight: "AMD等主要客户封测伙伴，CPU/GPU/存储先进封装产能扩张" },
          { name: "华天科技", highlight: "传统封测+车规级先进封装，南京/西安等多基地满产" },
          { name: "深科技", highlight: "沛顿存储封测+模组制造，DRAM/NAND封测与国内存储厂配套" },
          { name: "苏州固锝", highlight: "集成电路封测+WLCSP，功率与传感器芯片封测产能" },
          { name: "大港股份", highlight: "集成电路封测与测试，存储与功率芯片封测双线" },
          { name: "晶方科技", highlight: "CIS晶圆级封装WLCSP，TSV/3D封装技术量产" },
          { name: "德明利", highlight: "存储控制芯片+模组封测一体化，NAND颗粒导入放量" },
          { name: "蓝箭电子", highlight: "分立器件+集成电路封测，功率器件封装产能扩张" },
          { name: "国民技术", highlight: "安全芯片封测，MCU与安全芯片封装测试产能" }
        ]
      },
      {
        name: "传感器芯片",
        companies: [
          { name: "韦尔股份", highlight: "CIS图像传感器，手机/车载摄像头芯片出货量规模居前" },
          { name: "汇顶科技", highlight: "指纹识别+触控+光学传感，手机生物识别传感芯片" },
          { name: "水晶光电", highlight: "光学元器件+传感滤光片，手机摄像头光学传感组件" },
          { name: "汉威科技", highlight: "气体/压力/惯性传感器，工业与消费电子传感芯片" },
          { name: "歌尔股份", highlight: "MEMS麦克风+传感器模组，声学与环境传感组件" },
          { name: "赛微电子", highlight: "MEMS惯性/射频传感器，北斗导航与物联网传感" },
          { name: "航天电器", highlight: "特种连接器+传感组件，航空航天传感系统" },
          { name: "硕贝德", highlight: "天线+传感模组，5G终端与环境传感集成" },
          { name: "富瀚微", highlight: "视频传感+IPC芯片，安防视觉传感芯片" },
          { name: "苏州固锝", highlight: "压力/加速度传感器，汽车与工控传感芯片" }
        ]
      }
    ]
  },
  ...
  "AI算力": {
    ...
    description: "AI算力产业链涵盖算力芯片、AI服务器、量子计算、算力租赁、大数据、液冷、云计算、边缘计算、算力算法与PCB算力板等细分赛道，是大模型时代的核心基础设施。口径：主业与对应细分强相关；剔除科创板(688/689)。",
    upstream: [
      {
        name: "算力芯片",
        companies: [
          { name: "景嘉微", highlight: "国产GPU芯片龙头，JM系列图形/通用计算芯片信创与AI场景拓展" },
          { name: "紫光国微", highlight: "FPGA+安全芯片龙头，特种算力与数据中心加密加速芯片" },
          { name: "全志科技", highlight: "AIoT SoC龙头，端侧AI推理芯片与智能硬件算力平台" },
          { name: "北京君正", highlight: "嵌入式存储+MCU，低功耗AI推理与边缘算力芯片" },
          { name: "国科微", highlight: "视频编解码+AI芯片，安防与智能终端算力芯片量产" },
          { name: "富瀚微", highlight: "视频处理芯片龙头，IPC与边缘AI视觉算力芯片" },
          { name: "欧比特", highlight: "宇航电子+AI芯片，卫星与特种领域算力芯片" },
          { name: "航宇微", highlight: "卫星大数据+AI芯片，太空算力与特种计算芯片" },
          { name: "旋极信息", highlight: "嵌入式系统+安全芯片，行业算力终端与安全计算" },
          { name: "智度股份", highlight: "互联网营销+算力服务，端侧算力与智算资源整合" }
        ]
      },
      {
        name: "量子计算",
        companies: [
          { name: "科大国创", highlight: "量子计算软件+行业解决方案，政务与金融量子安全算力平台" },
          { name: "光迅科技", highlight: "光通信+量子器件，量子密钥分发与光量子器件量产" },
          { name: "华工科技", highlight: "激光+光器件，量子通信光模块与精密光学组件" },
          { name: "亨通光电", highlight: "光纤+量子通信，量子保密通信网络设备与系统集成" },
          { name: "烽火通信", highlight: "光通信全产业链，量子保密通信系统与网络设备" },
          { name: "神州信息", highlight: "金融IT+量子安全，银行量子加密与算力安全解决方案" },
          { name: "浙江东方", highlight: "量子通信产业投资，量子保密通信网络建设与运营" },
          { name: "雄帝科技", highlight: "智能证卡+安全芯片，量子加密身份认证与终端" },
          { name: "格尔软件", highlight: "密码安全+PKI，量子密钥管理与安全认证系统" },
          { name: "苏州科达", highlight: "视频会议+量子安全，政务量子加密通信终端" }
        ]
      },
      {
        name: "PCB算力板",
        companies: [
          ...
          { name: "深南电路", highlight: "高端PCB+封装基板，算力板+数据中心板市占率国内第一" },
          { name: "胜宏科技", highlight: "GPU加速卡PCB，H100/B200算力板量产交付" },
          { name: "景旺电子", highlight: "汽车+服务器PCB，智能驾驶域控制器与算力板" },
          { name: "鹏鼎控股", highlight: "全球PCB产值第一，AI服务器与交换机PCB核心供应商" },
          { name: "东山精密", highlight: "FPC+硬板，AI服务器与通信设备PCB" },
          { name: "广合科技", highlight: "AI服务器PCB新锐，算力板订单放量" },
          { name: "崇达技术", highlight: "高端小批量PCB，算力与通信设备多层板" },
          { name: "兴森科技", highlight: "IC载板+PCB，算力板与封装基板双线" },
          { name: "奥士康", highlight: "高端PCB制造，AI服务器与数据中心多层板扩产" }
        ]
      }
    ],
    midstream: [
      {
        ...
        companies: [
          ...
          { name: "拓维信息", highlight: "华为昇腾生态核心伙伴，兆瀚AI服务器出货量前三" },
          { name: "协创数据", highlight: "智算服务器、存储与物联网硬件，头部云及互联网客户供应链绑定紧" },
          { name: "闻泰科技", highlight: "AI服务器与智能终端ODM，头部云厂商服务器代工产能扩张" },
          { name: "华勤技术", highlight: "AI服务器ODM扩产，手机ODM龙头向智算硬件整机延伸" },
          { name: "龙旗科技", highlight: "智能硬件ODM龙头，AI服务器与智算硬件代工产能扩张" },
      ...
      },
      {
        ...
        companies: [
          ...
          { name: "高澜股份", highlight: "冷板+浸没双路线，字节/阿里/腾讯客户，PUE可降至1.1以内" },
          { name: "曙光数创", highlight: "浸没相变液冷龙头，液冷温控设备市占领先" },
          { name: "飞荣达", highlight: "导热界面材料+石墨散热模组，AI服务器液冷冷板与散热方案核心供应商" },
          { name: "中石科技", highlight: "导热垫片+均热板龙头，GPU/CPU高功率液冷散热界面材料" },
          { name: "川环科技", highlight: "液冷软管与密封系统龙头，数据中心液冷管路核心配套" },
          { name: "巨化股份", highlight: "氟化工龙头，浸没式液冷氟化冷却介质核心供应商" },
          { name: "三美股份", highlight: "电子级氟化液供应商，数据中心浸没与两相液冷介质" },
          { name: "银轮股份", highlight: "液冷板+换热系统龙头，数据中心液冷管路换热组件" }
        ]
      },
      {
        name: "算力租赁",
        companies: [
          { name: "鸿博股份", highlight: "英博数科智算中心，高端GPU集群租赁与算力运营龙头" },
          { name: "恒润股份", highlight: "润六尺智算中心，GPU算力租赁与AI训练集群运营" },
          { name: "中贝通信", highlight: "通信工程+智算中心，算力租赁与IDC运维一体化" },
          { name: "利通电子", highlight: "算力租赁转型标的，GPU集群投放与市场关注度居前" },
          { name: "润建股份", highlight: "通信运维+智算园区，IDC建设与代运营一体化" },
          { name: "亚康股份", highlight: "算力基础设施运维，头部互联网算力集群交付服务" },
          { name: "拓维信息", highlight: "华为昇腾生态伙伴，国产智算建设与算力服务" },
          { name: "首都在线", highlight: "公有云GPU与裸金属，弹性算力租赁代表厂商" },
          { name: "奥飞数据", highlight: "IDC+智算机柜，华南及海外节点算力租赁扩张" },
          { name: "南兴股份", highlight: "云计算+智算转型，算力租赁与云桌面协同" }
        ]
      }
    ],
    downstream: [
      {
        name: "云计算/IDC",
        companies: [
          { name: "润泽科技", highlight: "超大规模IDC智算园区，批发型云客户机架上架率行业领先" },
          { name: "光环新网", highlight: "京津冀IDC龙头，AI算力租赁与云计算托管扩张" },
          { name: "网宿科技", highlight: "CDN+云计算，边缘云与数据中心算力托管" },
          { name: "数据港", highlight: "阿里云核心数据中心合作方，上架率与云算力扩张同步" },
          { name: "奥飞数据", highlight: "华南及海外IDC，智算机柜与带宽资源弹性供给" },
          { name: "科华数据", highlight: "UPS+IDC一体化，智算数据中心建设与运营" },
          { name: "宝信软件", highlight: "IDC+工业互联网，宝之云数据中心与钢铁行业云" },
          { name: "美利云", highlight: "央企云数据中心，宁夏中卫算力枢纽节点" },
          { name: "首都在线", highlight: "全球云网一体化，GPU云与裸金属算力托管" },
          { name: "铜牛信息", highlight: "北京国资IDC，算力租赁与政务云托管" }
        ]
      },
      {
        name: "边缘计算",
        companies: [
          { name: "网宿科技", highlight: "CDN+边缘计算龙头，全球边缘节点与算力调度规模第一" },
          { name: "东软载波", highlight: "电力线载波+边缘IoT，智能电网与边缘算力终端" },
          { name: "移为通信", highlight: "物联网终端+边缘通信，车载与资产追踪边缘算力" },
          { name: "顺网科技", highlight: "网吧云+边缘算力，游戏与电竞边缘渲染节点" },
          { name: "广和通", highlight: "无线通信模组龙头，5G边缘网关与IoT算力终端" },
          { name: "美格智能", highlight: "智能模组+边缘AI，5G模组与边缘推理终端" },
          { name: "朗科科技", highlight: "存储+边缘计算，闪存与边缘数据算力终端" },
          { name: "高新兴", highlight: "车联网+公共安全IoT，边缘网关与视频物联网终端" },
          { name: "日海智能", highlight: "通信模组+边缘网关，运营商与行业IoT边缘算力终端" },
          { name: "宜通世纪", highlight: "通信服务+边缘算力，运营商边缘机房与算力节点" }
        ]
      },
      {
        name: "大数据",
        companies: [
          { name: "东方财富", highlight: "互联网券商+金融数据龙头，行情与交易高峰算力消耗行业第一" },
          { name: "同花顺", highlight: "金融信息服务商龙头，iFinD与量化回测算力需求旺盛" },
          { name: "三六零", highlight: "360智脑大模型+安全，搜索与安全场景大数据算力" },
          { name: "恒生电子", highlight: "金融IT龙头，机构交易与资管系统大数据处理" },
          { name: "顶点软件", highlight: "金融IT龙头，证券核心交易系统与量化回测算力平台" },
          { name: "指南针", highlight: "金融信息服务，证券分析与投资者教育大数据平台" },
          { name: "大智慧", highlight: "金融数据终端，行情资讯与量化工具用户规模领先" },
          { name: "银之杰", highlight: "金融科技+大数据，金融征信与数据服务算力平台" },
          { name: "零点有数", highlight: "数据分析+决策咨询，政务与商业大数据算力服务" },
          { name: "博彦科技", highlight: "IT服务+大数据，企业数字化与数据分析算力外包" }
        ]
      },
      {
        name: "算力算法",
        companies: [
          { name: "科大讯飞", highlight: "星火大模型龙头，语音与多模态AI算力调用行业第一" },
          { name: "拓尔思", highlight: "NLP+大数据，政务与媒体AI内容生成算力平台" },
          { name: "用友网络", highlight: "企业软件+AI大模型，BIP与行业大模型算力API调用领先" },
          { name: "泛微网络", highlight: "协同办公+AI助手，企业流程与文档智能算力服务" },
          { name: "汉王科技", highlight: "OCR+手写识别，文档智能与AI算力服务" },
          { name: "华宇软件", highlight: "法律AI+政务大模型，司法与政务算力应用落地" },
          { name: "深信服", highlight: "网络安全+AI，安全大模型与威胁检测算力" },
          { name: "美亚柏科", highlight: "电子取证+公共安全AI，大数据研判算力平台" },
          { name: "初灵信息", highlight: "视频智能+边缘AI，运营商与行业视觉算力" },
          { name: "榕基软件", highlight: "电子政务+信创，政务大数据与AI算力应用" }
        ]
      }
    ]
  },
  ...
  // ========== 锂电池 ==========
  // 口径：正负极/隔膜/电解液/铜箔材料、动力电池、固态电池、设备、储能、回收；剔除科创板(688/689)
  "锂电池": {
    name: "锂电池",
    color: "#0891b2",
    gradient: ["#0891b2", "#164e63"],
    description: "锂电池产业链覆盖正极/负极/电解液/隔膜/铜箔材料、动力电池电芯、固态电池、锂电设备、储能电池与电池回收等环节。2026年磷酸铁锂与储能需求拉动材料与电芯产能扩张。口径：主业与对应细分制造/出货量强相关；剔除科创板(688/689)。",
    upstream: [
      {
        name: "正极/前驱体材料",
        companies: [
          { name: "湖南裕能", highlight: "磷酸铁锂正极出货量规模居前，磷酸铁锂产线满产满销" },
          { name: "当升科技", highlight: "高镍NCM正极材料规模靠前，欧洲动力电池客户订单饱满" },
          { name: "中伟新材", highlight: "三元前驱体+正极材料一体化，前驱体产线规模国内领先" },
          { name: "德方纳米", highlight: "纳米磷酸铁锂正极材料，磷酸铁锂产线持续扩产" },
          { name: "丰元股份", highlight: "磷酸铁锂+草酸锂盐，正极材料与锂盐原料协同布局" },
          { name: "龙蟠科技", highlight: "磷酸铁锂正极材料扩产，车用润滑油与锂电材料双主业" },
          { name: "盟固利", highlight: "钴酸锂+三元正极材料，消费电子与动力电池正极双线" },
          { name: "华友钴业", highlight: "钴镍锂资源+三元前驱体，正极前驱体产线一体化" },
          { name: "杉杉股份", highlight: "人造石墨负极+正极材料，锂电材料双产品线协同" },
          { name: "科恒股份", highlight: "稀土发光材料+锂电正极，钴酸锂与三元正极产线" }
        ]
      },
      {
        name: "负极材料",
        companies: [
          { name: "贝特瑞", highlight: "人造石墨负极出货量规模居前，硅基负极产线持续导入" },
          { name: "璞泰来", highlight: "人造石墨负极+涂覆隔膜，负极材料产线满产" },
          { name: "尚太科技", highlight: "人造石墨负极材料，一体化石墨化产线成本优势突出" },
          { name: "中科电气", highlight: "电磁冶金设备+负极材料，石墨化与负极产线垂直整合" },
          { name: "翔丰华", highlight: "人造石墨负极材料，快充负极产线扩产" },
          { name: "方大炭素", highlight: "石墨电极+锂电负极石墨化，负极石墨化代工产能扩张" },
          { name: "道氏技术", highlight: "陶瓷釉面+锂电正极/负极材料，三元前驱体与负极协同" },
          { name: "百川股份", highlight: "精细化工+锂电负极石墨化，负极材料产线配套" },
          { name: "永东股份", highlight: "炭黑+针状焦原料，负极材料上游原料与石墨化配套" }
        ]
      },
      {
        name: "电解液/锂盐",
        companies: [
          { name: "天赐材料", highlight: "电解液出货量规模居前，LiFSI添加剂与六氟磷酸锂自供" },
          { name: "新宙邦", highlight: "电解液规模靠前厂商，海外动力电池客户与国内头部电芯厂订单饱满" },
          { name: "多氟多", highlight: "六氟磷酸锂+电解液一体化，氟化工锂盐与电解液产线满产" },
          { name: "瑞泰新材", highlight: "电解液与锂盐添加剂，动力电池电解液出货量行业前列" },
          { name: "天际股份", highlight: "六氟磷酸锂+LiFSI锂盐，电解液上游锂盐产线扩产" },
          { name: "胜华新材", highlight: "碳酸酯溶剂+电解液，溶剂与电解液一体化产线" },
          { name: "江苏国泰", highlight: "外贸+电解液子公司，电解液产能与锂盐配套" },
          { name: "永太科技", highlight: "氟化工中间体+电解液锂盐，LiFSI与电解液添加剂产线" },
          { name: "海科新源", highlight: "碳酸酯溶剂规模靠前，电解液溶剂与添加剂产线" },
          { name: "奥克股份", highlight: "环氧乙烷衍生物+电解液溶剂，碳酸酯溶剂产线配套" }
        ]
      },
      {
        name: "隔膜制造",
        companies: [
          { name: "恩捷股份", highlight: "湿法隔膜出货量规模居前，涂覆隔膜产线满产满销" },
          { name: "星源材质", highlight: "干法+湿法隔膜规模靠前，涂覆隔膜产线持续扩产" },
          { name: "中材科技", highlight: "玻纤+锂电隔膜，湿法隔膜产线与涂覆产能扩张" },
          { name: "沧州明珠", highlight: "PE隔膜+BOPA薄膜，干法隔膜产线配套动力电池" },
          { name: "欧克科技", highlight: "生活用纸设备+隔膜设备，隔膜产线设备与隔膜制造协同" },
          { name: "美联新材", highlight: "色母粒+隔膜涂覆，涂覆隔膜产线扩产" },
          { name: "佛塑科技", highlight: "薄膜新材料+锂电隔膜，干法隔膜产线配套" },
          { name: "东风股份", highlight: "烟标印刷+锂电隔膜，隔膜基材与涂覆产线" },
          { name: "乐凯胶片", highlight: "感光材料+锂电隔膜涂覆，隔膜涂覆产线配套" }
        ]
      },
      {
        name: "锂电铜箔",
        companies: [
          { name: "诺德股份", highlight: "锂电铜箔出货量规模居前，极薄铜箔产线满产" },
          { name: "德福科技", highlight: "极薄锂电铜箔规模靠前，6μm/4.5μm铜箔产线扩产" },
          { name: "铜冠铜箔", highlight: "铜箔制造规模靠前，锂电铜箔与电子电路铜箔双线" },
          { name: "中一科技", highlight: "锂电铜箔+标准铜箔，极薄铜箔产线持续爬坡" },
          { name: "超华科技", highlight: "覆铜板+锂电铜箔，铜箔产线与PCB材料协同" },
          { name: "逸豪新材", highlight: "电子电路铜箔+锂电铜箔，铜箔产线扩产" },
          { name: "楚江新材", highlight: "铜基材料+锂电铜箔，铜加工与铜箔产线协同" },
          { name: "众源新材", highlight: "铜带+锂电铜箔，高精度铜箔产线配套" },
          { name: "华锋股份", highlight: "电极箔+锂电铜箔，铝箔与铜箔材料双线" },
          { name: "金安国纪", highlight: "覆铜板+铜箔材料，电子铜箔与锂电铜箔配套" }
        ]
      }
    ],
    midstream: [
      {
        name: "动力电池电芯",
        companies: [
          { name: "宁德时代", highlight: "动力电池装机规模居前，麒麟/神行超充电池产线满产" },
          { name: "比亚迪", highlight: "刀片电池自供+外供双线，磷酸铁锂动力电池产线持续爬坡" },
          { name: "亿纬锂能", highlight: "大圆柱+软包动力电池产线，动力与储能电芯双线满产" },
          { name: "国轩高科", highlight: "磷酸铁锂动力电池产能扩张，大众合资产线与海外基地同步放量" },
          { name: "欣旺达", highlight: "动力电池PACK+电芯一体化，混动与纯电客户订单饱满" },
          { name: "中创新航", highlight: "三元+磷酸铁锂动力电池产线，乘用车与储能客户双线供货" },
          { name: "鹏辉能源", highlight: "动力+储能电芯制造，大储与轻型动力电池产线扩产" },
          { name: "雄韬股份", highlight: "铅酸+锂电双主业，氢燃料电池与动力电池产线协同" },
          { name: "蔚蓝锂芯", highlight: "小型动力+工具电池电芯，高倍率锂电池产线满产" }
        ]
      },
      {
        name: "固态电池",
        companies: [
          { name: "赣锋锂业", highlight: "固态锂电池量产进程领先，氧化物/硫化物固态电芯中试线扩产" },
          { name: "传艺科技", highlight: "钠离子+固态电池双线，固态电芯中试产线建设" },
          { name: "上海洗霸", highlight: "水处理+固态电解质材料，硫化物固态电解质产线" },
          { name: "德尔股份", highlight: "汽车隔音+固态电池，氧化物固态电芯中试线" },
          { name: "三祥新材", highlight: "锆系材料+固态电解质，氧化物固态电解质原料产线" },
          { name: "金龙羽", highlight: "电线电缆+固态电池，固态电芯中试产线建设" }
        ]
      },
      {
        name: "电池设备",
        companies: [
          { name: "先导智能", highlight: "锂电设备规模靠前厂商，涂布/卷绕/叠片整线交付满产" },
          { name: "赢合科技", highlight: "涂布+辊压+分切设备，动力电池产线设备出货量居前" },
          { name: "金银河", highlight: "有机硅设备+锂电浆料设备，涂布与搅拌设备产线满产" },
          { name: "星云股份", highlight: "锂电池检测+化成设备，电芯检测与PACK产线设备" },
          { name: "福能东方", highlight: "包装印刷设备+锂电设备，叠片与焊接设备产线" },
          { name: "天永智能", highlight: "汽车装配线+锂电模组产线，模组PACK自动化设备" },
          { name: "智云股份", highlight: "平板显示设备+锂电设备，叠片与焊接产线设备" },
          { name: "大族激光", highlight: "激光焊接+切割设备，动力电池极耳焊接与模组产线" },
          { name: "华自科技", highlight: "水利水电自动化+储能PACK产线，锂电模组装配设备" }
        ]
      },
      {
        name: "储能电池",
        companies: [
          { name: "阳光电源", highlight: "逆变器+储能系统，大储与工商业储能电池系统出货量居前" },
          { name: "南都电源", highlight: "铅酸+锂电储能，通信储能与大储电芯产线扩产" },
          { name: "科陆电子", highlight: "储能系统集成+电芯，海外大储项目储能电池出货放量" },
          { name: "上能电气", highlight: "光伏逆变器+储能系统，大储PCS与储能电池配套出货" }
        ]
      }
    ],
    downstream: [
      {
        name: "电池回收",
        companies: [
          { name: "格林美", highlight: "动力电池回收规模靠前，镍钴锂资源回收与梯次利用产线满产" },
          { name: "天奇股份", highlight: "汽车装备+电池回收，废旧动力电池拆解与再生产线" },
          { name: "光华科技", highlight: "PCB化学品+电池回收，磷酸铁锂与三元电池再生利用" },
          { name: "旺能环境", highlight: "垃圾焚烧+锂电回收，废旧电池资源化利用产线" },
          { name: "骆驼股份", highlight: "铅酸电池+锂电回收，废旧电池梯次利用与再生" },
          { name: "超越科技", highlight: "固废处理+电池回收，废旧动力电池拆解再生产线" },
          { name: "东江环保", highlight: "危废处理+电池回收，废旧电池无害化处置与资源化" },
          { name: "高能环境", highlight: "环境修复+危废处理，废旧锂电池回收与资源化产线" }
        ]
      },
      {
        name: "动力电池应用",
        companies: [
          { name: "赛力斯", highlight: "问界系列装机麒麟电池，单车带电量行业前列" },
  ...
  // ========== 消费电子 ==========
  // 口径：智能手机ODM、显示面板、TWS/声学、可穿戴、摄像头模组、充电设备制造主业；剔除科创板(688/689)
  "消费电子": {
    name: "消费电子",
    color: "#7c3aed",
    gradient: ["#be185d", "#7c3aed"],
    description: "消费电子产业链覆盖显示面板、摄像头模组、智能手机ODM、TWS/声学、可穿戴设备、充电设备等环节。AI手机、折叠屏与智能穿戴为2026年增量方向。口径：主业与对应细分制造/出货量强相关；剔除科创板(688/689)。",
    upstream: [
      {
        name: "显示面板",
        companies: [
          { name: "京东方A", highlight: "全球显示面板龙头，OLED/LCD出货量行业第一，折叠屏面板国内市占领先" },
          { name: "TCL科技", highlight: "华星光电面板龙头，大尺寸TV与IT/mobile OLED产能持续扩张" },
          { name: "深天马A", highlight: "中小尺寸LTPS/AMOLED面板龙头，车载与消费电子双轮驱动" },
          { name: "维信诺", highlight: "OLED面板龙头，柔性AMOLED量产与折叠屏面板供货" },
          { name: "华映科技", highlight: "显示面板制造，中小尺寸LCD/OLED模组与面板产能" },
          { name: "彩虹股份", highlight: "液晶玻璃基板+面板，显示产业链上游材料与面板协同" },
          { name: "同兴达", highlight: "显示模组+摄像头模组，中小尺寸显示模组出货量领先" },
          { name: "合力泰", highlight: "显示模组+手机ODM，全面屏显示模组与整机协同" },
          { name: "凯盛科技", highlight: "显示玻璃与触控模组，消费电子显示材料与模组" },
          { name: "莱宝高科", highlight: "中大尺寸触摸屏与显示模组，平板/笔记本显示模组" }
        ]
      },
      {
        name: "摄像头/光学",
        companies: [
          { name: "欧菲光", highlight: "手机摄像头模组龙头，光学影像模组出货量行业前列" },
          { name: "立讯精密", highlight: "摄像头模组精密组装，苹果摄像头模组核心供应商" },
          { name: "联创电子", highlight: "光学镜头+车载/手机摄像头模组，玻塑混合镜头龙头" },
          { name: "水晶光电", highlight: "光学元器件龙头，手机滤光片/镜头盖板与AR光学" },
          { name: "宇瞳光学", highlight: "安防与手机光学镜头龙头，玻塑混合镜头产能扩张" },
          { name: "五方光电", highlight: "红外截止滤光片龙头，手机摄像头光学镀膜核心供应商" },
          { name: "凤凰光学", highlight: "光学镜头+摄像头模组，安防与消费电子光学制造" },
          { name: "同兴达", highlight: "摄像头模组+显示模组，手机光学影像模组出货量领先" },
          { name: "蓝思科技", highlight: "玻璃盖板+摄像头镜片，手机摄像头结构件核心供应商" },
          { name: "道明光学", highlight: "光学膜与棱镜，手机摄像头光学元器件配套" }
        ]
      }
    ],
    midstream: [
      {
        name: "智能手机ODM",
        companies: [
          { name: "华勤技术", highlight: "手机ODM全球龙头，AI手机与智能硬件整机出货量行业前三" },
          { name: "龙旗科技", highlight: "智能手机ODM，小米/荣耀等品牌整机设计制造出货量领先" },
          { name: "闻泰科技", highlight: "手机ODM+半导体，智能硬件整机代工与品牌客户深度绑定" },
          { name: "光弘科技", highlight: "消费电子EMS龙头，手机/可穿戴整机组装产能扩张" },
          { name: "福日电子", highlight: "智能手机ODM与LED显示，华为/荣耀等客户整机代工" },
          { name: "合力泰", highlight: "显示模组+手机ODM，全面屏显示模组与整机协同出货" },
          { name: "卓翼科技", highlight: "消费电子ODM/EMS，智能手机与IoT硬件代工" },
          { name: "科森科技", highlight: "精密结构件+整机组装，智能手机金属件与EMS代工" },
          { name: "美格智能", highlight: "智能模组+IoT终端，5G模组与智能硬件ODM" },
          { name: "瑞德智能", highlight: "智能控制器+小家电/充电ODM，消费电子终端代工" }
        ]
      },
      {
        name: "TWS/声学",
        companies: [
          { name: "歌尔股份", highlight: "TWS耳机代工全球龙头，苹果AirPods核心供应商" },
          { name: "立讯精密", highlight: "连接器+声学+组装，AirPods/Watch核心制造与TWS代工" },
          { name: "国光电器", highlight: "声学喇叭+音箱/TWS代工，AI音箱与耳机ODM出货放量" },
          { name: "佳禾智能", highlight: "TWS耳机ODM龙头，品牌客户耳机与智能音箱代工" },
          { name: "朝阳科技", highlight: "电声器件+TWS耳机，消费电子声学零部件与整机代工" },
          { name: "漫步者", highlight: "音频设备品牌龙头，TWS耳机与智能音箱自有品牌出货" },
          { name: "天键股份", highlight: "耳机ODM龙头，TWS与头戴式耳机代工出货量行业前列" },
          { name: "惠威科技", highlight: "音响品牌+代工，TWS耳机与有源音箱出货" },
          { name: "共达电声", highlight: "微型电声元器件+TWS，声学器件与耳机代工" }
        ]
      },
      {
        name: "智能穿戴",
        companies: [
          { name: "立讯精密", highlight: "Apple Watch等可穿戴整机组装，可穿戴设备出货量核心供应商" },
          { name: "歌尔股份", highlight: "VR/AR+可穿戴声学，智能手表与耳机可穿戴代工" },
          { name: "环旭电子", highlight: "SiP封装+可穿戴模组，Apple Watch等可穿戴核心供应链" },
          { name: "华勤技术", highlight: "智能手表/手环ODM，可穿戴整机设计制造出货" },
          { name: "光弘科技", highlight: "可穿戴EMS代工，智能手表与手环整机组装" },
          { name: "佳禾智能", highlight: "TWS+可穿戴ODM，智能耳机与手环代工出货" },
          { name: "奋达科技", highlight: "智能音箱+可穿戴代工，TWS与智能手环ODM" },
          { name: "乐心医疗", highlight: "智能手环/健康穿戴设备，医疗级可穿戴出货量领先" },
          { name: "创维数字", highlight: "智能终端+VR/AR设备，可穿戴与算力硬件出货" },
          { name: "共达电声", highlight: "可穿戴声学器件，TWS与智能穿戴电声组件" }
        ]
      },
      {
        name: "结构件/精密制造",
        companies: [
          ...
          { name: "领益智造", highlight: "消费电子精密功能件与组装，苹果/Android供应链龙头" },
          { name: "立讯精密", highlight: "摄像头模组组装+精密制造，苹果供应链核心厂商" }
        ]
      }
    ],
    downstream: [
      {
        name: "充电设备",
        companies: [
          { name: "安克创新", highlight: "充电头/移动电源全球品牌龙头，氮化镓快充出货量领先" },
          { name: "奥海科技", highlight: "手机充电器ODM龙头，快充与PC电源代工出货量行业第一" },
          { name: "公牛集团", highlight: "民用电工龙头，数码充电与插座产品线出货量领先" },
          { name: "茂硕电源", highlight: "LED驱动电源+消费电子适配器，充电电源出货放量" },
          { name: "伊戈尔", highlight: "电源变压器与充电组件，消费电子电源配套" },
          { name: "拓邦股份", highlight: "智能控制器+充电产品，IoT与消费电子电源方案" },
          { name: "京泉华", highlight: "磁性元器件+电源适配器，充电器变压器与电源组件" },
          { name: "英可瑞", highlight: "电力电源+充电模块，充电桩与消费电子电源" },
          { name: "得润电子", highlight: "连接器+电源线束，消费电子充电连接组件" },
          { name: "瀛通通讯", highlight: "数据线+声学配件，Type-C线与充电配件出货" }
        ]
      },
      {
        name: "整机品牌",
    ...
    midstream: [
      ...
      },
      {
        ...
        companies: [
          ...
          { name: "顺络电子", highlight: "片式MLCC与电感量产，AI服务器与车规被动元件一体化供应" },
          { name: "东晶电子", highlight: "石英晶体与被动元件，MLCC及瓷介电容配套产能" }
        ]
      }
    ],
    downstream: [
  ...
  // ========== 电子纸 ==========
  // 口径：电子墨水膜/驱动IC、电子纸显示模组、电纸书/电子价签/教育办公等终端；不含面板泛显示及非电子纸主业的LED标的
  "电子纸": {
    name: "电子纸",
    color: "#0f766e",
    gradient: ["#14b8a6", "#0f766e"],
    description: "电子纸（E-Ink）为低功耗反射式显示技术，产业链涵盖电子墨水膜与驱动IC、电子纸显示模组制造，以及电纸书、电子价签（ESL）、教育办公本等终端应用。零售数字化与彩色化驱动行业扩张，2026年全球市场规模有望达约203亿美元。口径：主业或核心收入与电子纸材料/模组/终端强相关；科创板(688/689)标的不纳入本项目订单榜。",
    upstream: [
      {
        name: "驱动IC/主控芯片",
        companies: [
          { name: "瑞芯微", highlight: "AIoT芯片龙头，电子纸阅读器/价签/办公本SoC产品线完善" },
          { name: "全志科技", highlight: "平板与IoT主控芯片，电子纸平板与彩色电纸书方案出货放量" }
        ]
      },
      {
        name: "显示材料/辅材",
        companies: [
          { name: "飞凯材料", highlight: "显示用光刻胶与湿制程材料，电子纸模组封装与制程化学品配套" },
          { name: "莱宝高科", highlight: "中大尺寸触摸屏与显示模组，电子纸终端触控与贴合配套" }
        ]
      }
    ],
    midstream: [
      {
        name: "电子纸显示模组",
        companies: [
          { name: "亚世光电", highlight: "液晶显示+电子纸模组双主业，8条光电显示模组产线，电子纸模组核心供应商" },
          { name: "合力泰", highlight: "全球电子纸模组前五厂商，电子纸显示模组量产与中试线布局" },
          { name: "京东方A", highlight: "显示面板龙头，电子纸模组产能与元太合作模式受益零售数字化" },
          { name: "秋田微", highlight: "定制化液晶显示与电子纸显示模组，中小尺寸显示方案供应商" },
          { name: "深天马A", highlight: "中小尺寸显示面板，电子纸与特种显示模组配套供应" },
          { name: "光莆股份", highlight: "半导体光应用+显示配套，电子纸背光与显示器件相关布局" }
        ]
      },
      {
        name: "模组/终端一体化",
        companies: [
          { name: "汉王科技", highlight: "电纸书与AI手写办公本龙头，国内阅读器份额约18%，电子纸模组自研" },
          { name: "冠捷科技", highlight: "全球显示终端制造龙头，电子纸显示器与价签终端出货受益" }
        ]
      }
    ],
    downstream: [
      {
        name: "电纸书/阅读终端",
        companies: [
          { name: "掌阅科技", highlight: "数字阅读平台+电纸书硬件，国内阅读器品牌份额约24%" },
          { name: "汉王科技", highlight: "电纸书与手写电纸本，AI阅读与办公本订单持续放量" }
        ]
      },
      {
        name: "电子价签/商用显示",
        companies: [
          { name: "视源股份", highlight: "商用显示与交互平板龙头，零售电子价签与智慧商显方案放量" },
          { name: "科大讯飞", highlight: "AI办公本与电子纸手写终端，语音转写+墨水屏高客单价品类" }
        ]
      }
    ]
  },
  ...
  // ========== 商业航天 ==========
  // 口径：火箭发动机/箭体/卫星制造/火箭制造/通信/姿控/星座运营/太空算力/材料/测控；剔除科创板(688/689)
  "商业航天": {
    name: "商业航天",
    color: "#1d4ed8",
    gradient: ["#1d4ed8", "#1e3a8a"],
    description: "商业航天涵盖可复用火箭、卫星互联网星座、太空算力与航天测控等方向。2026年低轨星座组网+民营火箭试飞驱动产业加速落地。口径：主业与对应细分制造/运营强相关；剔除科创板(688/689)。",
    upstream: [
      {
        name: "火箭发动机/推进",
        companies: [
          { name: "航天动力", highlight: "液体火箭发动机制造规模靠前，液氧煤油发动机产线与推进系统配套满产" },
          { name: "钢研高纳", highlight: "高温合金铸件+涡轮盘，火箭发动机燃烧室与涡轮核心材料产线" },
          { name: "光韵达", highlight: "金属3D打印+激光装备，火箭发动机复杂构件增材制造产线" },
          { name: "派克新材", highlight: "航空航天锻件规模靠前，火箭发动机壳体与结构锻件产线满产" },
          { name: "火炬电子", highlight: "特种陶瓷电容器+高温材料，火箭发动机电子与热端材料配套" },
          { name: "新余国科", highlight: "火工品+特种装备，固体火箭发动机点火与分离装置产线" },
          { name: "晨曦航空", highlight: "航空发动机电子控制+惯性器件，火箭推进控制子系统配套" },
          { name: "上大股份", highlight: "高温合金锻件，火箭发动机涡轮盘与机匣锻件产线" },
          { name: "西部材料", highlight: "钛合金+难熔金属，火箭发动机喷管与结构材料产线" },
          { name: "博云新材", highlight: "炭/炭复合材料+粉末冶金，火箭发动机热端材料与刹车材料" }
        ]
      },
      {
        name: "箭体结构",
        companies: [
          { name: "超捷股份", highlight: "紧固件+箭体结构件，商业火箭箭体连接与结构配套出货量居前" },
          { name: "飞沃科技", highlight: "高强度紧固件规模靠前，火箭箭体结构连接件产线满产" },
          { name: "上海沪工", highlight: "焊接装备+航天结构制造，火箭贮箱与箭体结构焊接产线" },
          { name: "爱乐达", highlight: "航空零部件精密加工，火箭箭体结构件数控加工产线" },
          { name: "三角防务", highlight: "大型锻件+结构件，火箭箭体段部结构锻件产线" },
          { name: "航天晨光", highlight: "特种装备+压力容器，火箭燃料贮箱与管路结构产线" },
          { name: "中天火箭", highlight: "固体火箭+小型运载火箭，箭体结构总装与发射服务配套" },
          { name: "航天长峰", highlight: "安保+航天配套，火箭测发控与箭体地面支持结构" },
          { name: "光威复材", highlight: "碳纤维复合材料规模靠前，火箭箭体复合材料结构件产线" },
          { name: "新晨科技", highlight: "金融信息化+军工配套，火箭地面测控与结构信息化配套" }
        ]
      },
      {
        name: "航天材料",
        companies: [
          { name: "宝钛股份", highlight: "钛材规模靠前厂商，航天钛合金板材与锻件产线" },
          { name: "中简科技", highlight: "高性能碳纤维，航天航空结构用碳纤维产线" },
          { name: "图南股份", highlight: "高温合金精密铸件，航空发动机与航天热端铸件产线" }
        ]
      }
    ],
    midstream: [
      {
        name: "卫星制造",
        companies: [
          { name: "中国卫星", highlight: "小卫星总装规模靠前，低轨卫星星座组网制造平台满产" },
          { name: "航宇微", highlight: "宇航电子芯片+卫星制造，微纳卫星与宇航SOC产线" },
          { name: "航天电子", highlight: "星载计算机+测控设备，卫星电子系统配套出货量居前" },
          { name: "欧比特", highlight: "微纳卫星+遥感卫星，商业遥感卫星制造产线扩产" },
          { name: "航天科技", highlight: "航天科技集团上市平台，卫星研制与航天产品配套" },
          { name: "铖昌科技", highlight: "微波毫米波T/R芯片，卫星相控阵射频前端产线" },
          { name: "天箭科技", highlight: "高波段微波前端，卫星通信与雷达微波组件产线" },
          { name: "上海瀚讯", highlight: "宽带通信设备，卫星互联网地面站与星载通信配套" }
        ]
      },
      {
        name: "火箭制造/发射",
        companies: [
          { name: "航天动力", highlight: "液体火箭发动机+推进系统，运载火箭动力系统核心配套满产" },
          { name: "中天火箭", highlight: "固体火箭+小型运载火箭，商业航天发射服务产线" }
        ]
      },
      {
        name: "卫星姿态控制",
        companies: [
          { name: "天银机电", highlight: "星敏感器+惯性器件，卫星姿态测量与控制组件出货量居前" },
          { name: "航天电器", highlight: "特种连接器+继电器，卫星姿态控制与电源分配电子组件" },
          { name: "北斗星通", highlight: "北斗高精度定位模组，卫星姿态与轨道测定导航组件" }
        ]
      },
      {
        name: "太空算力",
        companies: [
          { name: "超图软件", highlight: "GIS数字地球+遥感云计算，太空算力地面数据中心与遥感处理平台" },
          { name: "普天科技", highlight: "通信网络+卫星算力，星座地面数据中心与算力调度平台" },
          { name: "四维图新", highlight: "高精地图+遥感大数据，星座遥感数据算力处理平台" }
        ]
      }
    ],
    downstream: [
      {
        name: "卫星通信",
        companies: [
          { name: "中国卫通", highlight: "高轨卫星通信运营+终端配套，Ka宽带卫星通信服务能力规模居前" },
          { name: "通宇通讯", highlight: "基站天线+卫星通信天线，卫星互联网地面天线产线满产" },
          { name: "华力创通", highlight: "卫星通信终端+基带芯片，天通卫星手机直连配套" },
          { name: "海格通信", highlight: "北斗+卫星通信双模终端，军用与民用卫星通信出货量居前" },
          { name: "振芯科技", highlight: "北斗导航+卫星通信芯片，卫星通信基带与射频芯片产线" },
          { name: "盛路通信", highlight: "通信天线+卫星通信，卫星通信射频与天线组件产线" },
          { name: "信维通信", highlight: "移动终端天线+卫星通信，卫星通信终端天线与射频模组" }
        ]
      },
      {
        name: "星座运营",
        companies: [
          { name: "中国卫通", highlight: "高轨卫星通信运营规模靠前，Ka宽带与广播通信星座服务能力" },
          { name: "四维图新", highlight: "高精地图+遥感数据服务，低轨星座数据应用与运营平台" },
          { name: "航宇微", highlight: "微纳卫星星座+宇航芯片，遥感星座在轨运营与数据服务" },
          { name: "北斗星通", highlight: "北斗高精度定位运营，导航增强与星座数据服务" },
          { name: "超图软件", highlight: "GIS数字地球+遥感平台，星座遥感数据运营与应用服务" },
          { name: "普天科技", highlight: "通信网络+卫星应用，低轨星座通信运营与系统集成" },
          { name: "欧比特", highlight: "遥感卫星星座运营，珠海一号星座数据服务与在轨管理" }
        ]
      },
      {
        name: "航天测控",
        companies: [
          { name: "海格通信", highlight: "卫星测控+通信终端，航天测控地面站与终端系统出货量居前" },
          { name: "华力创通", highlight: "卫星通信+测控基带，航天测控终端与信号处理系统" },
          { name: "雷科防务", highlight: "雷达+卫星应用，航天测控雷达与遥感信号处理系统" },
          { name: "航天电子", highlight: "星载测控+地面设备，航天测控电子系统核心配套" },
          { name: "中国卫星", highlight: "小卫星+测控集成，航天测控地面站与卫星测控分系统" },
          { name: "普天科技", highlight: "通信网络+测控集成，航天测控通信网络与系统集成" },
          { name: "航天长峰", highlight: "安保+测控电子，航天发射测控与安保安防系统" },
          { name: "北斗星通", highlight: "北斗测控+高精度定位，航天测控导航增强与监测" },
          { name: "振芯科技", highlight: "北斗芯片+测控，航天测控基带与射频芯片系统" },
          { name: "晨曦航空", highlight: "惯性导航+飞控，航天测控惯性测量与飞行控制系统" }
        ]
      }
    ]
  },
    ...
    upstream: [
      {
        ...
        companies: [
          ...
          { name: "飞凯材料", highlight: "覆铜板专用树脂与湿制程材料，高频高速CCL化学品配套" },
          { name: "福莱新材", highlight: "功能性涂布薄膜，CCL封装保护膜与MLCC离型膜配套" },
          { name: "圣泉集团", highlight: "酚醛树脂与电子化学品，覆铜板粘结剂与CCL基材核心供应商" }
        ]
      },
      {
        name: "专用材料/设备",
  ...
  // ========== 存储芯片 ==========
  // 口径：DRAM/NAND/NOR 设计制造、存储封测、模组、封装基板/覆铜板及产线设备材料；不含泛消费电子芯片、面板及非存储主业的 PCB 龙头
  "存储芯片": {
    name: "存储芯片",
    color: "#0369a1",
    gradient: ["#0284c7", "#075985"],
    description: "存储芯片产业链覆盖 DRAM/NAND/NOR 闪存设计、晶圆制造与封测、存储模组及控制芯片，以及存储封装基板、覆铜板与产线设备材料。国产替代与 AI 服务器拉动存储景气，长鑫/长江存储扩产带动配套订单。口径：主业或核心收入与存储芯片/模组/封测强相关；科创板(688/689)标的不纳入本项目订单榜。",
    upstream: [
      {
        name: "存储产线设备/材料",
        companies: [
          { name: "北方华创", highlight: "刻蚀/沉积/CVD 等设备龙头，DRAM/NAND 产线扩产核心国产设备商" },
          { name: "长川科技", highlight: "存储器封测与晶圆电测设备，DRAM 产线后道测试扩产直接受益" },
          { name: "雅克科技", highlight: "电子特气与前驱体，DRAM/NAND 产线 CVD/刻蚀用高纯材料配套" },
          { name: "太极实业", highlight: "子公司十一科技承担长鑫存储等存储厂工程总包，厂建订单直接受益" },
          { name: "生益科技", highlight: "存储用覆铜板全球龙头，存储封装基板上游 CCL 材料核心供应商" }
        ]
      },
      {
        name: "存储封装基板/辅材",
        companies: [
          { name: "深南电路", highlight: "存储配套封装基板龙头，FC-BGA 载板直供 OSAT 与存储封测" },
          { name: "兴森科技", highlight: "IC 载板+存储封装基板，CSP/FCBGA 产能爬坡配套存储扩产" }
        ]
      }
    ],
    midstream: [
      {
        name: "存储芯片设计",
        companies: [
          { name: "兆易创新", highlight: "NOR Flash 全球第二，持股长鑫科技，低功耗闪存与 DRAM 生态协同" },
          { name: "北京君正", highlight: "嵌入式存储+MCU，低功耗存储芯片，车规与物联网存储控制器" },
          { name: "德明利", highlight: "存储控制芯片隐形冠军，主控+模组一体化，国产 NAND 颗粒导入放量" }
        ]
      },
      {
        name: "存储封测",
        companies: [
          ...
          { name: "苏州固锝", highlight: "集成电路封测与WLCSP，存储芯片BGA/DFN等先进封测产能" }
        ]
      }
    ],
    downstream: [
      {
        name: "存储模组/渠道",
        companies: [
          { name: "江波龙", highlight: "存储模组龙头，国产 DRAM/NAND 颗粒导入与渠道放量，全场景覆盖" },
          { name: "德明利", highlight: "存储主控+模组出货，嵌入式与行业存储订单饱满" }
        ]
      },
      {
        name: "长鑫/国产存储生态",
        companies: [
          ...
          { name: "朗迪集团", highlight: "通过产业基金间接参股长鑫科技，国产存储资本化预期映射" }
        ]
      }
    ]
  },
    ...
    midstream: [
      ...
      },
      {
        ...
        companies: [
          ...
          { name: "苏州固锝", highlight: "集成电路封测与WLCSP先进封装，2.5D/3D及存储芯片封测产能" }
        ]
      }
    ],
    downstream: [
  ...
  // ========== 电子布（电子级玻璃纤维布 / AI-PCB上游）==========
  "电子布": {
    name: "电子布",
    color: "#b45309",
    gradient: ["#d97706", "#92400e"],
    description: "电子布（电子级玻璃纤维布）是覆铜板（CCL）与PCB的核心增强材料。AI服务器高阶PCB需求爆发，薄布/超薄布/Low-Dk特种电子布供需紧张，2026年行业呈现涨价与零库存。口径：电子纱/电子布制造及特种纤维布主业；剔除科创板(688/689)。",
    upstream: [
      {
        name: "电子纱/原纱",
        companies: [
          ...
          { name: "金发科技", highlight: "改性塑料与玻纤增强复合材料，电子纱/风电纱制品配套" },
          { name: "道恩股份", highlight: "热塑性弹性体与玻纤增强材料，低介电电子纱制品增强辅材" },
          { name: "万马股份", highlight: "高分子缆料与玻纤增强材料，电子纱/风电纱制品护套配套" },
          { name: "惠柏新材", highlight: "风电叶片环氧树脂+玻纤增强材料，风电纱与电子纱制品配套" }
        ]
      }
    ],
    midstream: [
      {
        name: "电子布/特种纤维布制造",
        companies: [
          { name: "宏和科技", highlight: "极薄T布/Low-Dk/Low-CTE特种电子布，AI服务器PCB核心基材" },
          { name: "中国巨石", highlight: "7628/薄布/超薄布全系列，淮安/桐乡扩产巩固全球第一" },
          { name: "中材科技", highlight: "泰山玻纤特种纤维布1917万米批量供货，低膨胀布打破垄断" },
          { name: "国际复材", highlight: "珠海珠玻电子布工艺传承，高端AI电子布持续突破" },
          { name: "长海股份", highlight: "玻纤制品，电子布与特种玻纤布配套" }
        ]
      }
    ],
    downstream: [
  ...
  "2026年初涨幅榜": {
    ...
    description: "2026年首个交易日至最近收盘，沪深主板/创业板年初至今涨幅前15名（剔除科创板/北交所/ST）。每家公司登记涨幅、上涨原因及归因类型：业绩（基本面兑现）、情绪（板块/政策催化）、炒作（题材博弈）。行情来源东方财富，仅供学习，不构成投资建议。",
    upstream: [
      {
        name: "涨幅排行",
        companies: [
          { name: "详见海报", highlight: "切换至「产业链海报」标签查看 Top15 完整榜单、涨幅与涨跌归因" }
        ]
      }
    ],
    midstream: [],
