    ...
    upstream: [
      {
        name: "AI服务器与算力整机",
        companies: [
          { /* code: "601138" */ name: "工业富联", highlight: "AI 服务器代工与整机出货规模领先，同花顺算力租赁主题中市值与营收体量居前" },
          { /* code: "000977" */ name: "浪潮信息", highlight: "国内 AI 服务器与整机柜头部供应商，智算中心扩容直接拉动租赁商采购" },
          { /* code: "603019" */ name: "中科曙光", highlight: "国产高端服务器与液冷方案，政务与行业智算项目常见算力底座供应商" },
          { /* code: "000938" */ name: "紫光股份", highlight: "新华三服务器与网络设备，数据中心与智算网络一体化交付能力强" }
        ]
      },
      {
        name: "光互联与网络设备",
        companies: [
          { /* code: "300308" */ name: "中际旭创", highlight: "800G/1.6T 光模块龙头，智算集群东西向与跨机柜带宽决定集群可出租规模" },
          { /* code: "300502" */ name: "新易盛", highlight: "数通光模块高增，云与智算数据中心互联需求与租赁上架节奏同步" },
          { /* code: "000063" */ name: "中兴通讯", highlight: "数据中心交换机与算力网络，大集群组网与运维为租赁商刚需" }
        ]
      },
      {
        name: "电力工程与机房温控",
        companies: [
          { /* code: "601668" */ name: "中国能建", highlight: "能源电力与新型基础设施工程，算力租赁主题中营收体量居前，绿电配套与园区供电相关" },
          { /* code: "002837" */ name: "英维克", highlight: "精密温控与液冷，高密度 GPU 机柜 PUE 与可上架功率直接影响租赁经济性" },
          { /* code: "002518" */ name: "科士达", highlight: "UPS 与数据中心供配电，保障智算机柜连续供电与租赁 SLA" }
        ]
      }
    ],
    midstream: [
      {
        ...
        companies: [
          { /* code: "300442" */ name: "润泽科技", highlight: "超大规模园区级 IDC/智算，批发型客户与云厂商需求绑定深，概念成分中利润体量突出" },
          { /* code: "603881" */ name: "数据港", highlight: "阿里云核心数据中心合作方，上架率与云侧算力扩张同步" },
          { /* code: "300383" */ name: "光环新网", highlight: "京津冀等地 IDC+云，企业与大模型客户托管及算力服务需求稳定" },
          { /* code: "300738" */ name: "奥飞数据", highlight: "华南及海外节点扩张，智算机柜与带宽资源弹性大" }
        ]
      },
      {
        name: "GPU云/弹性算力与国产算力服务",
        companies: [
          { /* code: "300846" */ name: "首都在线", highlight: "公有云 GPU 与裸金属实例产品线明确，中小客户与出海弹性算力租赁代表" },
          { /* code: "300017" */ name: "网宿科技", highlight: "边缘计算与分发能力叠加，算力租赁主题下近端成交与算力调度关注度较高" },
          { /* code: "603629" */ name: "利通电子", highlight: "财经报道中高频出现的算力租赁转型标的，智算资源投放与市场关注度居前" },
          { /* code: "002261" */ name: "拓维信息", highlight: "华为昇腾生态核心伙伴之一，国产智算建设与行业算力服务绑定深" }
        ]
      },
      {
        name: "智算建设与运维服务",
        companies: [
          { /* code: "002929" */ name: "润建股份", highlight: "通信与 IDC 运维、智算园区建设与代运营一体化" },
          { /* code: "301085" */ name: "亚康股份", highlight: "算力基础设施运维与交付，头部互联网及云客户算力集群配套服务" },
          { /* code: "603887" */ name: "城地香江", highlight: "由传统工程向 IDC/算力服务转型，机柜与算力收入结构改善受市场跟踪" }
        ]
      }
    ],
    downstream: [
      {
        name: "大模型与多模态应用",
        companies: [
          { /* code: "002230" */ name: "科大讯飞", highlight: "星火大模型训练与推理算力消耗大，自建与第三方租赁并行" },
          { /* code: "300418" */ name: "昆仑万维", highlight: "天工与多模态应用峰值算力需求高，弹性租用云 GPU 降本" },
          { /* code: "601360" */ name: "三六零", highlight: "大模型与安全场景推理部署，对云端与托管算力采购需求持续" },
          { /* code: "300624" */ name: "万兴科技", highlight: "AIGC 创意工具全球化，渲染与推理波峰外包算力租赁" }
        ]
      },
      {
        name: "金融与营销科技",
        companies: [
          { /* code: "300033" */ name: "同花顺", highlight: "金融大模型与量化回测，行情与研报高峰时段短时算力租用需求" },
          { /* code: "300484" */ name: "蓝色光标", highlight: "营销 AIGC 与多模态内容生产，项目制算力租赁与云厂商联动多" },
          { /* code: "600588" */ name: "用友网络", highlight: "企业级 AI 与行业大模型落地，混合云下算力外采与租赁并存" }
        ]
      },
      {
        name: "智算服务器与云生态（需求侧硬件）",
        companies: [
          { /* code: "300857" */ name: "协创数据", highlight: "智算服务器、存储与物联网硬件，公开报道中与头部云及互联网客户供应链绑定紧" },
          { /* code: "000034" */ name: "神州数码", highlight: "IT 分销与神州鲲泰信创服务器，云与行业客户算力硬件渠道与交付" },
          { /* code: "002602" */ name: "世纪华通", highlight: "游戏与云游戏、AIGC 管线对渲染与推理算力外包有持续需求" }
        ]
      }
    ]
  }
