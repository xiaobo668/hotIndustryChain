/**
 * 产业链数据库
 * 包含：半导体、AI算力、算力租赁、预制算力中心底座、新能源汽车、光伏、电力、人工智能、锂电池、消费电子、机器人、液冷、通讯设备、IT服务、元件、MLCC、半导体稀缺材料、多氟多、AI应用、无人驾驶、特斯拉FSD入华、长鑫存储、先进封装、光互联、CPO、物理AI、2022世界杯、2026世界杯 等（产业链见 INDUSTRY_DATA；板块龙头见 sector-data.js 的 SECTOR_DATA）
 */
const INDUSTRY_DATA = {
  // ========== 半导体 ==========
  "半导体": {
