...
function renderShiliaoOrganResult(data) {
  ...
  document.getElementById('shiliao-stats').innerHTML = `
    <div class="shiliao-stat">
      ...
      <div class="shiliao-stat-label">偏爱食材</div>
    </div>
    <div class="shiliao-stat">
  ...
  renderShiliaoOrganDetail(data);
  renderShiliaoOrganVoiceover(data);

  const posterPages = document.getElementById('shiliao-poster-pages');
  if (posterPages) posterPages.innerHTML = '';
}

function renderShiliaoOrganDetail(data) {
...
function renderShiliaoOrganVoiceover(data) {
