...
const ORDER_RANK_POSTER_CONFIG = [
  ...
  { key: 'AI大脑算力芯片', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-ai-brain-chip-wrap', pagesId: 'order-rank-pa-ai-brain-chip-pages', canvasId: 'order-rank-pa-ai-brain-chip-canvas' },
  { key: '视觉与3D感知', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-vision-3d-wrap', pagesId: 'order-rank-pa-vision-3d-pages', canvasId: 'order-rank-pa-vision-3d-canvas' },
  { key: '力觉触觉传感器', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-force-touch-wrap', pagesId: 'order-rank-pa-force-touch-pages', canvasId: 'order-rank-pa-force-touch-canvas' },
  { key: '控制芯片边缘AI', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-control-edge-wrap', pagesId: 'order-rank-pa-control-edge-pages', canvasId: 'order-rank-pa-control-edge-canvas' },
  { key: '电机与执行部件', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-motor-actuator-wrap', pagesId: 'order-rank-pa-motor-actuator-pages', canvasId: 'order-rank-pa-motor-actuator-canvas' },
  { key: '丝杠轴承传动件', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-screw-bearing-wrap', pagesId: 'order-rank-pa-screw-bearing-pages', canvasId: 'order-rank-pa-screw-bearing-canvas' },
  { key: '减速器精密运动', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-reducer-motion-wrap', pagesId: 'order-rank-pa-reducer-motion-pages', canvasId: 'order-rank-pa-reducer-motion-canvas' },
  { key: '功率半导体驱动', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-power-semi-wrap', pagesId: 'order-rank-pa-power-semi-pages', canvasId: 'order-rank-pa-power-semi-canvas' },
  { key: '工控控制系统', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-industrial-control-wrap', pagesId: 'order-rank-pa-industrial-control-pages', canvasId: 'order-rank-pa-industrial-control-canvas' },
  { key: '伺服与运动控制', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-servo-motion-wrap', pagesId: 'order-rank-pa-servo-motion-pages', canvasId: 'order-rank-pa-servo-motion-canvas' },
  { key: '电池稀土磁材', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-battery-magnet-wrap', pagesId: 'order-rank-pa-battery-magnet-pages', canvasId: 'order-rank-pa-battery-magnet-canvas' },
  { key: '结构件机电模组', industryKeys: ['物理AI', '人形机器人', '机器人'], wrapId: 'order-rank-pa-structure-module-wrap', pagesId: 'order-rank-pa-structure-module-pages', canvasId: 'order-rank-pa-structure-module-canvas' },
