...
const ORDER_SECTION_HINTS = {
  ...
  火箭制造: '运载火箭整箭及动力系统配套市场规模参考（亿元）。',
  卫星通信: '卫星通信终端、天线、芯片等配套市场规模参考（亿元，规模指数换算）。',
  卫星姿态控制: '星敏感器、惯性器件、姿控电子配套市场规模参考（亿元，规模指数换算）。',
  星座运营: '星座运营与数据服务市场规模参考（亿元，规模指数换算）。',
  太空算力: '卫星在轨/地面遥感数据处理市场规模参考（亿元，规模指数换算）。',
  航天材料: '钛合金、高温合金、碳纤维等航天材料市场规模参考（亿元）。',
  航天测控: '航天测控地面站、终端、雷达系统市场规模参考（亿元）。',
};
