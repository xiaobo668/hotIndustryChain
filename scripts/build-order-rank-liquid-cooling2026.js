...
const ENTRIES = [
  {
    rank: 1, name: '浪潮信息', amount: 85, orderLabel: '液冷订单约85亿元',
    highlight: '液冷服务器国内市占60%+，2026年4月斩获字节跳动百亿级AI订单，液冷占比超85%',
    ...
    note: '客户订单为百亿级AI服务器采购，按液冷占比85%估算约85亿元',
  },
  {
  ...
  {
    rank: 3, name: '英维克', amount: 40, orderLabel: '海外订单超40亿元',
    highlight: '全链条液冷龙头，谷歌TPU CDU、英伟达UQD/CDU，Coolinside累计交付超1.16GW',
    sourceType: 'media', source: '国际液冷产业大会·行业调研纪要', sourceDate: '2026-01-16',
    sourceUrl: 'https://lctexpo.com/news/684.html',
    note: '行业调研口径2025年底至2026年初海外在手/跟踪订单，非公司公告拆分披露',
    officialCross: { field: 'amount', min: 40, ref: '调研纪要：海外订单超40亿，潜在确定性订单40-50亿' },
  },
  {
    ...
    note: '截至2025年9月末液冷相关在手订单38亿元（总在手60.3亿）；2026年5月无更新总额披露',
  },
  {
    rank: 5, name: '巨化股份', amount: 18, orderLabel: '冷却液订单约18亿元',
  ...
  {
    rank: 6, name: '高澜股份', amount: 14.98, orderLabel: '在手订单14.98亿元',
  ...
  {
    rank: 8, name: '曙光数创', amount: 8.82, orderLabel: '2025年营收8.82亿元',
  ...
  {
    rank: 9, name: '佳力图', amount: 7.39, orderLabel: '2025年营收7.39亿元',
    highlight: '机房精密空调+液冷配套，运营商与IDC温控设备供应商',
    sourceType: 'official', source: '佳力图2025年年度报告', sourceDate: '2025全年',
    sourceUrl: 'http://static.cninfo.com.cn/finalpage/2026-03-24/1225026036.PDF',
    note: '未披露液冷在手订单；以2025年报营收7.39亿元作规模参考排序',
  },
  {
    rank: 10, name: '银轮股份', amount: 0.8, orderLabel: '液冷散热系统约0.8亿元',
    highlight: '数据中心液冷散热系统193+108套订单，累计可支撑500MW+算力热管理',
    sourceType: 'official', source: '银轮股份关于控股子公司获得采购订单的公告', sourceDate: '2024-12-24',
    sourceUrl: 'https://www.cls.cn/detail/1898978',
    note: '193套（2024-12）+108套（2024-08）算力中心液冷散热系统，单套约20-30万元估算约0.8亿',
    officialCross: { field: 'amount', min: 0.5, ref: '公司称新订单规模几千万元；301套×约25万/套估算' },
  },
];
...
const payload = {
  ...
  subtitle: '1-6：公开报道/官方披露2026年在手或预计订单；7-10：产业链节点以2025年报业务规模或公告订单作参考',
  generatedAt: '2026-05',
