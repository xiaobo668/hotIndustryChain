...
const SECTOR_DATA = {
  ...
  "多氟多": {
    ...
    description: "基于多氟多产业链梳理：前锋（情绪龙头）与中军（趋势龙头）均选自产业链节点、且为非科创板（688/689）标的。",
    vanguard: {
      title: "多氟多板块前锋（情绪龙头）",
      companies: [
        { name: "天际股份", highlight: "六氟磷酸锂弹性纯度标的，涨价周期业绩敏感，情绪先锋（非科创）" },
        { name: "石大胜华", highlight: "电解液溶剂弹性标的，景气回升时率先反应，适合情绪端" },
      ]
    },
    center: {
      title: "多氟多板块中军（趋势龙头）",
      companies: [
        { name: "多氟多", highlight: "六氟磷酸锂销量龙头，满产满销+电池放量，产业链趋势中军" },
        { name: "天赐材料", highlight: "电解液一体化绝对龙头，长协订单可跟踪，机构趋势配置" },
        { name: "新宙邦", highlight: "电解液龙头海外+国内双线，订单稳健，趋势标的" },
      ]
    }
  },
  "AI应用": {
  ...
  "预制算力中心底座": {
    ...
    description: "基于预制算力中心底座产业链梳理：前锋（情绪龙头）与中军（趋势龙头）均选自产业链节点、且为非科创板（688/689）标的。",
    vanguard: {
      title: "预制算力中心底座板块前锋（情绪龙头）",
      companies: [
        { name: "依米康", highlight: "预制化智算机房弹性标的，算力中心底座主题活跃时辨识度高，情绪先锋" },
        { name: "城地香江", highlight: "IDC转型+算力基建预期博弈，预制交付弹性大，情绪标的" },
      ]
    },
    center: {
      title: "预制算力中心底座板块中军（趋势龙头）",
      companies: [
        { name: "润泽科技", highlight: "模块化智算园区龙头，上架率直接兑现，预制算力中心趋势中军" },
        { name: "科士达", highlight: "UPS供配电龙头，智算底座刚需，机构趋势配置" },
        { name: "浪潮信息", highlight: "AI服务器整机龙头，预制算力集群交付核心，趋势走势稳健" },
      ]
    }
  },
  "核聚变": {
  ...
  "存储芯片": {
    ...
    color: "#0369a1",
    gradient: ["#0284c7", "#075985"],
    description: "基于存储芯片产业链梳理：前锋（情绪龙头）与中军（趋势龙头）均选自产业链节点、且为非科创板（688/689）标的。",
    vanguard: {
      title: "存储芯片板块前锋（情绪龙头）",
      companies: [
        { name: "德明利", highlight: "存储主控+模组纯度标的，订单催化时弹性大，情绪先锋（非科创）" },
        { name: "朗迪集团", highlight: "间接参股长鑫，国产存储资本化预期博弈强，典型情绪映射" },
      ]
    },
    center: {
      title: "存储芯片板块中军（趋势龙头）",
      companies: [
        { name: "江波龙", highlight: "存储模组龙头，国产颗粒导入放量，订单可跟踪，趋势中军" },
        { name: "兆易创新", highlight: "NOR Flash+长鑫协同，存储芯片设计龙头，机构趋势配置" },
        { name: "长电科技", highlight: "全球OSAT龙头，存储/HBM封测订单饱满，趋势核心" },
      ]
    }
  },
  "长鑫存储": {
  ...
  "光纤概念": {
    ...
    color: "#0891b2",
    gradient: ["#06b6d4", "#0e7490"],
    description: "基于光纤概念（AI算力光纤光缆）产业链梳理：前锋（情绪龙头）与中军（趋势龙头）均选自产业链节点、且为非科创板（688/689）标的。",
    vanguard: {
      title: "光纤概念板块前锋（情绪龙头）",
      companies: [
